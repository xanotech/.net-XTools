...
namespace XTools {
    public class ConcurrentSet<T> : ISet<T> {
        ...
        ///   <paramref name="array"/>.-or-Type <paramref name="T"/> cannot be cast automatically
        ...
        /// </summary>
        /// <returns>
        ///   true if the <see cref="T:System.Collections.Generic.ISet`1"/> object is a
        ///   correct superset of <paramref name="other"/>; otherwise, false.
        /// </returns>
        /// <param name="other">The collection to compare to the current set. </param>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="other"/> is null.</exception>
        ...
        public bool TryRemove(T item) {
            bool temp;
            return data.TryRemove(item, out temp);
        } // end method
        ...
        ///   are present in both the current set and in the specified collection.
        /// </summary>
        /// <param name="other">The collection to compare to the current set.</param>
        /// <exception cref="T:System.ArgumentNullException"><paramref name="other"/> is null.</exception>
